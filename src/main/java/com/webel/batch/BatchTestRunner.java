...
import static com.webel.batch.SongFileReader.readSongsFromFile;
...
//        runBatchReadFileWriteTest();
    ...
    void runBatchReadTest() {
        ...
        List<Song> songs = readSongsFromFile(pathToSongData);
    ...
    public void runBatchReadFileWriteTest() {
        ...
        //load all songs into memory
        Collection<Song> songs = readSongsFromFile(pathToSongData);
